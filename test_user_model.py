...
class UserModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        user1 = User.signup("test1", "fake1@gmail.com", "password", None)
        userid1 = 1111
        user1.id = userid1

        user2 = User.signup("test2", "fake2@gmail.com", "password", None)
        userid2 = 2222
        user2.id = userid2
    ...
    def test_valid_signup(self):
        user_test = User.signup("test", "fake@gmail.com", "password", None)
        uid = 9000
        user_test.id = uid
        db.session.commit()

        u_test = User.query.get(uid)
        # test if user is commited to database
        self.assertIsNotNone(u_test)
        self.assertEqual(u_test.username, "test")
        self.assertEqual(u_test.email, "fake@gmail.com")
